...
<body>
    ...
    <div class="container">
        ...
        <button type="button" onclick="location.href='normal_login.php'">NORMAL USER</button><br />

        <button type="button" onclick="location.href='admin_login.php'">ADMIN PANEL</button>
